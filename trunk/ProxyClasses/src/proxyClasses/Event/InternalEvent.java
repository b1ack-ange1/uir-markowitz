...
/**
 * Cache' Java Class Generated for class Event.InternalEvent on version Cache for Windows (x86-32) 2010.1.4 (Build 803) Tue Aug 24 2010 00:04:40 EDT.<br>
 *
 * @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=LISE_F&CLASSNAME=Event.InternalEvent</A>
**/

public class InternalEvent extends com.intersys.classes.Persistent {
    private static final long serialVersionUID = 356;
    private static String CACHE_CLASS_NAME = "Event.InternalEvent";
    /**
           <p>NB: DO NOT USE IN APPLICATION(!!!).
           <br>Use <code>Event.InternalEvent.open</code> instead!</br></p>
           <p>
    ...
    */
    public InternalEvent (com.intersys.cache.CacheObject ref) throws com.intersys.objects.CacheException {
        super (ref);
    }
    public InternalEvent (com.intersys.objects.Database db, String initstr) throws com.intersys.objects.CacheException {
        super (((com.intersys.cache.SysDatabase)db).newCacheObject (CACHE_CLASS_NAME,initstr));
    }
    /**
       Creates a new instance of object "Event.InternalEvent" in Cache
       database and corresponding object of class
       <code>Event.InternalEvent</code>.
       ...
       @throws com.intersys.objects.CacheException in case of error.
              ...
              @see #open(com.intersys.objects.Database, com.intersys.objects.Oid)
     */
    public InternalEvent (com.intersys.objects.Database db) throws com.intersys.objects.CacheException {
    ...
    * objects must be instances of <code>Event.InternalEvent</code> and not of its
    ...
    */
    ...
    /**
       ...
       object. This object may be of <code>Event.InternalEvent</code> or of
      any of its subclasses. Cast to <code>Event.InternalEvent</code> is
    ...
    /**
      ...
      @see java.lang.ClassCastException
           @see #_open(com.intersys.objects.Database, com.intersys.objects.Oid)
           @see #open(com.intersys.objects.Database, com.intersys.objects.Oid)
           @see #InternalEvent(com.intersys.objects.Database)
     */
    ...
    * to open all instances of class Event.InternalEvent
    ...
    */
    ...
    /**
       Returns class name of the class Event.InternalEvent as it is in
   ...
   */
    ...
    public static void checkAllFieldsValid(com.intersys.objects.Database db ) throws com.intersys.objects.CacheException {
        checkAllFieldsValid(db, CACHE_CLASS_NAME, InternalEvent.class);
    }
    ...
    public static void checkAllMethods(com.intersys.objects.Database db ) throws com.intersys.objects.CacheException {
        checkAllMethods(db, CACHE_CLASS_NAME, InternalEvent.class);
    }
    ...
    /**
       ...
       @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=LISE_F&CLASSNAME=Event.InternalEvent#ChangeAmount"> ChangeAmount</A>
    */
    ...
    */
    ...
    /**
       ...
       @throws com.intersys.objects.CacheException if any error occurred during value retrieval.
       @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=LISE_F&CLASSNAME=Event.InternalEvent#ChangePersent"> ChangePersent</A>
    */
    ...
    */
    ...
    /**
       ...
       @throws com.intersys.objects.CacheException if any error occurred during value retrieval.
       @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=LISE_F&CLASSNAME=Event.InternalEvent#ChangingDirection"> ChangingDirection</A>
    */
    ...
    */
    ...
    /**
       ...
       @throws com.intersys.objects.CacheException if any error occurred during value retrieval.
       @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=LISE_F&CLASSNAME=Event.InternalEvent#HappenedDate"> HappenedDate</A>
    */
    ...
    */
    ...
    /**
       ...
       @throws com.intersys.objects.CacheException if any error occurred during value retrieval.
       @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=LISE_F&CLASSNAME=Event.InternalEvent#HappenedTime"> HappenedTime</A>
    */
...
with the pre-package behaviour of %ClassName.</p>
     ...
     @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=LISE_F&CLASSNAME=Event.InternalEvent#%ClassName"> Method %ClassName</A>
    */
    ...
    /**
     ...
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=LISE_F&CLASSNAME=Event.InternalEvent#%ComposeOid"> Method %ComposeOid</A>
    */
...
transaction is committed, otherwise it is rolled back. </p>
     ...
     @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=LISE_F&CLASSNAME=Event.InternalEvent#%Delete"> Method %Delete</A>
    */
...
<p>Returns a <CLASS>%Status</CLASS> value indicating success or failure.</p>
     ...
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=LISE_F&CLASSNAME=Event.InternalEvent#%DeleteExtent"> Method %DeleteExtent</A>
    */
...
on the optional <var>concurrency</var> argument.</p>
     ...
     @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=LISE_F&CLASSNAME=Event.InternalEvent#%DeleteId"> Method %DeleteId</A>
    */
...
on the optional <var>concurrency</var> argument.</p>
    ...
    */
    ...
    /**
     ...
     @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=LISE_F&CLASSNAME=Event.InternalEvent#%Exists"> Method %Exists</A>
    */
    ...
    */
    ...
    /**
     ...
     @param id represented as java.lang.String
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=LISE_F&CLASSNAME=Event.InternalEvent#%ExistsId"> Method %ExistsId</A>
    */
...
That is 'isclass' is a primary superclass of this object.</p>
     ...
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=LISE_F&CLASSNAME=Event.InternalEvent#%IsA"> Method %IsA</A>
    */
...
extent physical data.</p>
     @param db represented as com.intersys.objects.Database
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=LISE_F&CLASSNAME=Event.InternalEvent#%KillExtent"> Method %KillExtent</A>
    */
...
<p>Returns a <CLASS>%Status</CLASS> value indicating success or failure.</p>
     ...
     @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=LISE_F&CLASSNAME=Event.InternalEvent#%SaveIndices"> Method %SaveIndices</A>
    */
...
<p>Returns a <CLASS>%Status</CLASS> value indicating success or failure.</p>
    ...
    */
    ...
    /**
     ...
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=LISE_F&CLASSNAME=Event.InternalEvent#ChangeAmountDisplayToLogical"> Method ChangeAmountDisplayToLogical</A>
    */
    ...
    /**
     ...
     @param _val represented as java.lang.String
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=LISE_F&CLASSNAME=Event.InternalEvent#ChangeAmountIsValid"> Method ChangeAmountIsValid</A>
    */
    ...
    /**
     ...
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=LISE_F&CLASSNAME=Event.InternalEvent#ChangeAmountLogicalToDisplay"> Method ChangeAmountLogicalToDisplay</A>
    */
    ...
    /**
     ...
     @param _val represented as java.lang.String
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=LISE_F&CLASSNAME=Event.InternalEvent#ChangePersentDisplayToLogical"> Method ChangePersentDisplayToLogical</A>
    */
    ...
    /**
     ...
     @param _val represented as java.lang.String
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=LISE_F&CLASSNAME=Event.InternalEvent#ChangePersentIsValid"> Method ChangePersentIsValid</A>
    */
    ...
    /**
     ...
     @param _val represented as java.lang.Double
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=LISE_F&CLASSNAME=Event.InternalEvent#ChangePersentLogicalToDisplay"> Method ChangePersentLogicalToDisplay</A>
    */
    ...
    /**
     ...
     @param _val represented as java.lang.String
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=LISE_F&CLASSNAME=Event.InternalEvent#ChangingDirectionDisplayToLogical"> Method ChangingDirectionDisplayToLogical</A>
    */
    ...
    /**
     ...
     @param _val represented as java.lang.String
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=LISE_F&CLASSNAME=Event.InternalEvent#ChangingDirectionIsValid"> Method ChangingDirectionIsValid</A>
    */
    ...
    /**
     ...
     @param _val represented as java.lang.String
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=LISE_F&CLASSNAME=Event.InternalEvent#ChangingDirectionLogicalToDisplay"> Method ChangingDirectionLogicalToDisplay</A>
    */
    ...
    /**
     ...
     @param _val represented as java.lang.String
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=LISE_F&CLASSNAME=Event.InternalEvent#HappenedDateDisplayToLogical"> Method HappenedDateDisplayToLogical</A>
    */
    ...
    /**
     ...
     @param _val represented as java.lang.String
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=LISE_F&CLASSNAME=Event.InternalEvent#HappenedDateIsValid"> Method HappenedDateIsValid</A>
    */
    ...
    /**
     ...
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=LISE_F&CLASSNAME=Event.InternalEvent#HappenedDateLogicalToDisplay"> Method HappenedDateLogicalToDisplay</A>
    */
    ...
    /**
     ...
     @param _val represented as java.lang.String
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=LISE_F&CLASSNAME=Event.InternalEvent#HappenedTimeDisplayToLogical"> Method HappenedTimeDisplayToLogical</A>
    */
    ...
    /**
     ...
     @param _val represented as java.lang.String
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=LISE_F&CLASSNAME=Event.InternalEvent#HappenedTimeIsValid"> Method HappenedTimeIsValid</A>
    */
    ...
    /**
     ...
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=LISE_F&CLASSNAME=Event.InternalEvent#HappenedTimeLogicalToDisplay"> Method HappenedTimeLogicalToDisplay</A>
    */
    ...
    /**
     ...
     @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=LISE_F&CLASSNAME=Event.InternalEvent#IDKEYDelete"> Method IDKEYDelete</A>
    */
    ...
    */
    ...
    /**
     ...
     @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=LISE_F&CLASSNAME=Event.InternalEvent#IDKEYExists"> Method IDKEYExists</A>
    */
    ...
    */
    ...
    /**
     ...
     @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=LISE_F&CLASSNAME=Event.InternalEvent#IONewGetObject"> Method IONewGetObject</A>
    */
    ...
    */
    ...
    /**
     ...
     @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=LISE_F&CLASSNAME=Event.InternalEvent#IONewGetObjectId"> Method IONewGetObjectId</A>
    */
    ...
    */
    ...
    /**
     ...
     @param db represented as com.intersys.objects.Database
     @param K1 represented as IO.InternalIO
     default argument id set to ""
     @throws com.intersys.objects.CacheException if any error occured while running the method.
    ...
    */
    ...
    /**
     ...
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=LISE_F&CLASSNAME=Event.InternalEvent#IONewIsValid"> Method IONewIsValid</A>
    */
    ...
    /**
     ...
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=LISE_F&CLASSNAME=Event.InternalEvent#IONewSetObject"> Method IONewSetObject</A>
    */
    ...
    /**
     ...
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=LISE_F&CLASSNAME=Event.InternalEvent#IONewSetObjectId"> Method IONewSetObjectId</A>
    */
    ...
    /**
     ...
     @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=LISE_F&CLASSNAME=Event.InternalEvent#IOoldGetObject"> Method IOoldGetObject</A>
    */
    ...
    */
    ...
    /**
     ...
     @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=LISE_F&CLASSNAME=Event.InternalEvent#IOoldGetObjectId"> Method IOoldGetObjectId</A>
    */
    ...
    */
    ...
    /**
     ...
     @param value represented as java.lang.String
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=LISE_F&CLASSNAME=Event.InternalEvent#IOoldIsValid"> Method IOoldIsValid</A>
    */
    ...
    /**
     ...
     @param newvalue represented as com.intersys.objects.Oid
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=LISE_F&CLASSNAME=Event.InternalEvent#IOoldSetObject"> Method IOoldSetObject</A>
    */
    ...
    /**
     ...
     @param newid represented as java.lang.String
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=LISE_F&CLASSNAME=Event.InternalEvent#IOoldSetObjectId"> Method IOoldSetObjectId</A>
    */
    ...
    /**
     ...
     @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=LISE_F&CLASSNAME=Event.InternalEvent#TickerGetObject"> Method TickerGetObject</A>
    */
    ...
    */
    ...
    /**
     ...
     @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=LISE_F&CLASSNAME=Event.InternalEvent#TickerGetObjectId"> Method TickerGetObjectId</A>
    */
    ...
    */
    ...
    /**
     ...
     @param value represented as java.lang.String
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=LISE_F&CLASSNAME=Event.InternalEvent#TickerIsValid"> Method TickerIsValid</A>
    */
    ...
    /**
     ...
     @param newvalue represented as com.intersys.objects.Oid
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=LISE_F&CLASSNAME=Event.InternalEvent#TickerSetObject"> Method TickerSetObject</A>
    */
    ...
    /**
     ...
     @param newid represented as java.lang.String
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=LISE_F&CLASSNAME=Event.InternalEvent#TickerSetObjectId"> Method TickerSetObjectId</A>
    */
    ...
    */
    public static com.intersys.objects.CacheQuery query_Extent (com.intersys.objects.Database db) throws com.intersys.objects.CacheException {
        return new com.intersys.objects.CacheQuery(db, "Event.InternalEvent_Extent", 0, 0);
    }
    ...
    public static java.util.List executeBatchInsert (java.sql.Connection con, Object batch, int nolock) throws java.sql.SQLException {
        Object ids = com.intersys.jdbc.QuickStatement.Batch.execute ("Event", "InternalEvent", 4, batch, con, nolock);
