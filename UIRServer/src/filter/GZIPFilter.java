 ...
 * <ul>
 * <li>The filter is mapped to a matching path
 * <li>The response status code is >=200 and <300
 * <li>The content length is unknown or more than the minGzipSize initParameter
 * or the minGzipSize is 0(default)
 * <li>The content-type is in the coma separated list of mimeTypes set in the
 * mimeTypes initParameter or if no mimeTypes are defined the content-type is
 * not "application/gzip"</li>
 * <li>No content-encoding is specified by the resource
 * </ul>
 * 
 * <p>
		...
		public void setContentType(String ct) {
			...
			if ((_gzStream == null || _gzStream._out == null)
					&& (_mimeTypes == null
							...
							&& !_mimeTypes.contains(ct.toLowerCase()))) {
				noGzip();
			}
		}
		...
		public void doGzip() throws IOException {
			if (_gzOut == null) {
				...
				if (setContentEncodingGzip()) {
					_out = _gzOut = new GZIPOutputStream(_response
							.getOutputStream(), _bufferSize);
			...
			if (_out == null || _bOut != null) {
				...
				if (_contentLength >= 0) {
					if (_contentLength < Integer.MAX_VALUE)
						...
						_response.setHeader("Content-Length", Long
								.toString(_contentLength));
				}
