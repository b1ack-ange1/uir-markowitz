...
/**
 * Cache' Java Class Generated for class Portfolio.CompositionInternal on version Cache for Windows (x86-32) 2010.1.4 (Build 803) Tue Aug 24 2010 00:04:40 EDT.<br>
 *
 * @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=LISE_F&CLASSNAME=Portfolio.CompositionInternal</A>
**/

public class CompositionInternal extends com.intersys.classes.Persistent {
    private static final long serialVersionUID = 7181;
    private static String CACHE_CLASS_NAME = "Portfolio.CompositionInternal";
    /**
           <p>NB: DO NOT USE IN APPLICATION(!!!).
           <br>Use <code>Portfolio.CompositionInternal.open</code> instead!</br></p>
           <p>
    ...
    */
    public CompositionInternal (com.intersys.cache.CacheObject ref) throws com.intersys.objects.CacheException {
        super (ref);
    }
    public CompositionInternal (com.intersys.objects.Database db, String initstr) throws com.intersys.objects.CacheException {
        super (((com.intersys.cache.SysDatabase)db).newCacheObject (CACHE_CLASS_NAME,initstr));
    }
    /**
       Creates a new instance of object "Portfolio.CompositionInternal" in Cache
       database and corresponding object of class
       <code>Portfolio.CompositionInternal</code>.
       ...
       @throws com.intersys.objects.CacheException in case of error.
              ...
              @see #open(com.intersys.objects.Database, com.intersys.objects.Oid)
     */
    public CompositionInternal (com.intersys.objects.Database db) throws com.intersys.objects.CacheException {
    ...
    * objects must be instances of <code>Portfolio.CompositionInternal</code> and not of its
    ...
    */
    ...
    /**
       ...
       object. This object may be of <code>Portfolio.CompositionInternal</code> or of
      any of its subclasses. Cast to <code>Portfolio.CompositionInternal</code> is
    ...
    /**
      ...
      @see java.lang.ClassCastException
           @see #_open(com.intersys.objects.Database, com.intersys.objects.Oid)
           @see #open(com.intersys.objects.Database, com.intersys.objects.Oid)
           @see #CompositionInternal(com.intersys.objects.Database)
     */
    ...
    * to open all instances of class Portfolio.CompositionInternal
    ...
    */
    ...
    /**
       Returns class name of the class Portfolio.CompositionInternal as it is in
   ...
   */
    ...
    public static void checkAllFieldsValid(com.intersys.objects.Database db ) throws com.intersys.objects.CacheException {
        checkAllFieldsValid(db, CACHE_CLASS_NAME, CompositionInternal.class);
    }
    ...
    public static void checkAllMethods(com.intersys.objects.Database db ) throws com.intersys.objects.CacheException {
        checkAllMethods(db, CACHE_CLASS_NAME, CompositionInternal.class);
    }
    private static int ii_Percentage = 1;
    private static int jj_Percentage = 0;
    private static int kk_Percentage = 1;
    /**
       Verifies that indexes for property <code>Percentage</code> in
       zObjVal are the same as in Cache. It does not return anything
       but it throws an exception in case of inconsistency.
     ...
     */
    public static void checkPercentageValid (com.intersys.objects.Database db) throws com.intersys.objects.CacheException {
        checkZobjValid(db, CACHE_CLASS_NAME, "Percentage",ii_Percentage, jj_Percentage, kk_Percentage);
    }
    /**
       Returns value of property <code>Percentage</code>.
       <Description>
       @return current value of <code>Percentage</code> represented as
       <code>java.lang.Double</code>

       @throws com.intersys.objects.CacheException if any error occurred during value retrieval.
       @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=LISE_F&CLASSNAME=Portfolio.CompositionInternal#Percentage"> Percentage</A>
    */
    public java.lang.Double getPercentage()  throws com.intersys.objects.CacheException {
        com.intersys.cache.Dataholder dh = mInternal.getProperty(ii_Percentage,
                                                jj_Percentage,
    ...
    /**
       Sets new value for <code>Percentage</code>.
       <Description>
       ...
       @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=LISE_F&CLASSNAME=Portfolio.CompositionInternal#Percentage"> Percentage</A>
    */
    public void setPercentage(java.lang.Double value)  throws com.intersys.objects.CacheException {
        com.intersys.cache.Dataholder dh = new com.intersys.cache.Dataholder (value);
        mInternal.setProperty(ii_Percentage, jj_Percentage,kk_Percentage, com.intersys.objects.Database.RET_PRIM, "Percentage", dh);
        return;
    }
    ...
    /**
       ...
       @throws com.intersys.objects.CacheException if any error occurred during value retrieval.
       @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=LISE_F&CLASSNAME=Portfolio.CompositionInternal#Portfolio"> Portfolio</A>
    */
    ...
    */
    ...
    /**
       ...
       @throws com.intersys.objects.CacheException if any error occurred during value retrieval.
       @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=LISE_F&CLASSNAME=Portfolio.CompositionInternal#Ticker"> Ticker</A>
    */
...
with the pre-package behaviour of %ClassName.</p>
     ...
     @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=LISE_F&CLASSNAME=Portfolio.CompositionInternal#%ClassName"> Method %ClassName</A>
    */
    ...
    /**
     ...
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=LISE_F&CLASSNAME=Portfolio.CompositionInternal#%ComposeOid"> Method %ComposeOid</A>
    */
...
transaction is committed, otherwise it is rolled back. </p>
     ...
     @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=LISE_F&CLASSNAME=Portfolio.CompositionInternal#%Delete"> Method %Delete</A>
    */
...
<p>Returns a <CLASS>%Status</CLASS> value indicating success or failure.</p>
     ...
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=LISE_F&CLASSNAME=Portfolio.CompositionInternal#%DeleteExtent"> Method %DeleteExtent</A>
    */
...
on the optional <var>concurrency</var> argument.</p>
     ...
     @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=LISE_F&CLASSNAME=Portfolio.CompositionInternal#%DeleteId"> Method %DeleteId</A>
    */
...
on the optional <var>concurrency</var> argument.</p>
    ...
    */
    ...
    /**
     ...
     @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=LISE_F&CLASSNAME=Portfolio.CompositionInternal#%Exists"> Method %Exists</A>
    */
    ...
    */
    ...
    /**
     ...
     @param id represented as java.lang.String
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=LISE_F&CLASSNAME=Portfolio.CompositionInternal#%ExistsId"> Method %ExistsId</A>
    */
...
That is 'isclass' is a primary superclass of this object.</p>
     ...
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=LISE_F&CLASSNAME=Portfolio.CompositionInternal#%IsA"> Method %IsA</A>
    */
...
extent physical data.</p>
     @param db represented as com.intersys.objects.Database
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=LISE_F&CLASSNAME=Portfolio.CompositionInternal#%KillExtent"> Method %KillExtent</A>
    */
...
<p>Returns a <CLASS>%Status</CLASS> value indicating success or failure.</p>
     ...
     @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=LISE_F&CLASSNAME=Portfolio.CompositionInternal#%SaveIndices"> Method %SaveIndices</A>
    */
...
<p>Returns a <CLASS>%Status</CLASS> value indicating success or failure.</p>
    ...
    */
    ...
    /**
     <p>Runs method CallCountCovars in Cache.</p>
     @param db represented as com.intersys.objects.Database
     @param porifolioId represented as java.lang.Integer
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=LISE_F&CLASSNAME=Portfolio.CompositionInternal#CallCountCovars"> Method CallCountCovars</A>
    */
    public static void CallCountCovars (com.intersys.objects.Database db, java.lang.Integer porifolioId) throws com.intersys.objects.CacheException {
        com.intersys.cache.Dataholder[] args = new com.intersys.cache.Dataholder[1];
        args[0] = new com.intersys.cache.Dataholder(porifolioId);
        com.intersys.cache.Dataholder res=db.runClassMethod(CACHE_CLASS_NAME,"CallCountCovars",args,com.intersys.objects.Database.RET_PRIM);
        db.parseStatus(res);
        return;
    }
    /**
     ...
     @param portfolioId represented as java.lang.Integer
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=LISE_F&CLASSNAME=Portfolio.CompositionInternal#CountCovariances"> Method CountCovariances</A>
    */
    public static void CountCovariances (com.intersys.objects.Database db, java.util.List tickerIds, java.lang.Integer portfolioId) throws com.intersys.objects.CacheException {
        com.intersys.cache.Dataholder[] args = new com.intersys.cache.Dataholder[2];
        args[0] = new com.intersys.cache.Dataholder(tickerIds);
        args[1] = new com.intersys.cache.Dataholder(portfolioId);
    ...
    /**
     ...
     @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=LISE_F&CLASSNAME=Portfolio.CompositionInternal#IDKEYDelete"> Method IDKEYDelete</A>
    */
    ...
    */
    ...
    /**
     ...
     @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=LISE_F&CLASSNAME=Portfolio.CompositionInternal#IDKEYExists"> Method IDKEYExists</A>
    */
    ...
    */
    ...
    /**
     ...
     @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=LISE_F&CLASSNAME=Portfolio.CompositionInternal#IDKEYOpen"> Method IDKEYOpen</A>
    */
    public static proxyClasses.Portfolio.CompositionInternal IDKEYOpen (com.intersys.objects.Database db, java.lang.String K1) throws com.intersys.objects.CacheException {
        com.intersys.cache.Dataholder[] args = new com.intersys.cache.Dataholder[1];
        args[0] = new com.intersys.cache.Dataholder(K1);
        ...
        if (cobj == null)
            return null;
        return (proxyClasses.Portfolio.CompositionInternal)(cobj.newJavaInstance());
    }
    /**
     <p>Runs method IDKEYOpen in Cache.</p>
     @param db represented as com.intersys.objects.Database
     ...
     @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=LISE_F&CLASSNAME=Portfolio.CompositionInternal#IDKEYOpen"> Method IDKEYOpen</A>
    */
    public static proxyClasses.Portfolio.CompositionInternal IDKEYOpen (com.intersys.objects.Database db, java.lang.String K1, java.lang.Integer concurrency) throws com.intersys.objects.CacheException {
        com.intersys.cache.Dataholder[] args = new com.intersys.cache.Dataholder[2];
        args[0] = new com.intersys.cache.Dataholder(K1);
        args[1] = new com.intersys.cache.Dataholder(concurrency);
        com.intersys.cache.Dataholder res=db.runClassMethod(CACHE_CLASS_NAME,"IDKEYOpen",args,com.intersys.objects.Database.RET_OBJECT);
    ...
    /**
     ...
     @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=LISE_F&CLASSNAME=Portfolio.CompositionInternal#IDKEYOpen"> Method IDKEYOpen</A>
    */
    public static proxyClasses.Portfolio.CompositionInternal IDKEYOpen (com.intersys.objects.Database db, java.lang.String K1, java.lang.Integer concurrency, com.intersys.objects.StatusCodeHolder sc) throws com.intersys.objects.CacheException {
        com.intersys.cache.Dataholder[] args = new com.intersys.cache.Dataholder[3];
        int[] _refs = new int[1];
        args[0] = new com.intersys.cache.Dataholder(K1);
        args[1] = new com.intersys.cache.Dataholder(concurrency);
    ...
    /**
     <p>Runs method PercentageDisplayToLogical in Cache.</p>
     @param db represented as com.intersys.objects.Database
     @param _val represented as java.lang.String
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=LISE_F&CLASSNAME=Portfolio.CompositionInternal#PercentageDisplayToLogical"> Method PercentageDisplayToLogical</A>
    */
    public static java.lang.Double PercentageDisplayToLogical (com.intersys.objects.Database db, java.lang.String _val) throws com.intersys.objects.CacheException {
        com.intersys.cache.Dataholder[] args = new com.intersys.cache.Dataholder[1];
        args[0] = new com.intersys.cache.Dataholder(_val);
        com.intersys.cache.Dataholder res=db.runClassMethod(CACHE_CLASS_NAME,"PercentageDisplayToLogical",args,com.intersys.objects.Database.RET_PRIM);
        return res.getDouble();
    }
    /**
     <p>Runs method PercentageIsValid in Cache.</p>
     @param db represented as com.intersys.objects.Database
     @param _val represented as java.lang.String
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=LISE_F&CLASSNAME=Portfolio.CompositionInternal#PercentageIsValid"> Method PercentageIsValid</A>
    */
    public static void PercentageIsValid (com.intersys.objects.Database db, java.lang.String _val) throws com.intersys.objects.CacheException {
        com.intersys.cache.Dataholder[] args = new com.intersys.cache.Dataholder[1];
        args[0] = new com.intersys.cache.Dataholder(_val);
        com.intersys.cache.Dataholder res=db.runClassMethod(CACHE_CLASS_NAME,"PercentageIsValid",args,com.intersys.objects.Database.RET_PRIM);
        db.parseStatus(res);
        return;
    }
    /**
     <p>Runs method PercentageLogicalToDisplay in Cache.</p>
     @param db represented as com.intersys.objects.Database
     @param _val represented as java.lang.Double
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=LISE_F&CLASSNAME=Portfolio.CompositionInternal#PercentageLogicalToDisplay"> Method PercentageLogicalToDisplay</A>
    */
    public static java.lang.String PercentageLogicalToDisplay (com.intersys.objects.Database db, java.lang.Double _val) throws com.intersys.objects.CacheException {
        com.intersys.cache.Dataholder[] args = new com.intersys.cache.Dataholder[1];
        args[0] = new com.intersys.cache.Dataholder(_val);
        com.intersys.cache.Dataholder res=db.runClassMethod(CACHE_CLASS_NAME,"PercentageLogicalToDisplay",args,com.intersys.objects.Database.RET_PRIM);
        return res.getString();
    }
    /**
     ...
     @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=LISE_F&CLASSNAME=Portfolio.CompositionInternal#PortfolioGetObject"> Method PortfolioGetObject</A>
    */
    ...
    */
    ...
    /**
     ...
     @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=LISE_F&CLASSNAME=Portfolio.CompositionInternal#PortfolioGetObjectId"> Method PortfolioGetObjectId</A>
    */
    ...
    */
    ...
    /**
     ...
     @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=LISE_F&CLASSNAME=Portfolio.CompositionInternal#PortfolioIndexExists"> Method PortfolioIndexExists</A>
    */
    ...
    */
    ...
    /**
     ...
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=LISE_F&CLASSNAME=Portfolio.CompositionInternal#PortfolioIsValid"> Method PortfolioIsValid</A>
    */
    ...
    /**
     ...
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=LISE_F&CLASSNAME=Portfolio.CompositionInternal#PortfolioSetObject"> Method PortfolioSetObject</A>
    */
    ...
    /**
     ...
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=LISE_F&CLASSNAME=Portfolio.CompositionInternal#PortfolioSetObjectId"> Method PortfolioSetObjectId</A>
    */
    ...
    /**
     ...
     @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=LISE_F&CLASSNAME=Portfolio.CompositionInternal#TickerGetObject"> Method TickerGetObject</A>
    */
    ...
    */
    ...
    /**
     ...
     @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=LISE_F&CLASSNAME=Portfolio.CompositionInternal#TickerGetObjectId"> Method TickerGetObjectId</A>
    */
    ...
    */
    ...
    /**
     ...
     @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=LISE_F&CLASSNAME=Portfolio.CompositionInternal#TickerIndexExists"> Method TickerIndexExists</A>
    */
    ...
    */
    ...
    /**
     ...
     @param value represented as java.lang.String
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=LISE_F&CLASSNAME=Portfolio.CompositionInternal#TickerIsValid"> Method TickerIsValid</A>
    */
    ...
    /**
     ...
     @param newvalue represented as com.intersys.objects.Oid
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=LISE_F&CLASSNAME=Portfolio.CompositionInternal#TickerSetObject"> Method TickerSetObject</A>
    */
    ...
    /**
     ...
     @param newid represented as java.lang.String
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://cache-server:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=LISE_F&CLASSNAME=Portfolio.CompositionInternal#TickerSetObjectId"> Method TickerSetObjectId</A>
    */
    ...
    */
    public static com.intersys.objects.CacheQuery query_Extent (com.intersys.objects.Database db) throws com.intersys.objects.CacheException {
        return new com.intersys.objects.CacheQuery(db, "Portfolio.CompositionInternal_Extent", 0, 0);
    }

    public static Object addToBatchInsert (Object batch, java.sql.Connection con, Double cos_Percentage, Integer cos_Portfolio, Integer cos_Ticker) throws java.sql.SQLException {
        if (batch == null) {
        ...
        com.intersys.jdbc.SysListProxy.setDoubleWrapper(qbatch.list, cos_Percentage);
    ...
    public static java.util.List executeBatchInsert (java.sql.Connection con, Object batch, int nolock) throws java.sql.SQLException {
        Object ids = com.intersys.jdbc.QuickStatement.Batch.execute ("Portfolio", "CompositionInternal", 4, batch, con, nolock);
